...
if(regexHREF.test(window.location.href)) {
  ...
  if(!(localStorage.getItem("productListArray") === null)) {
    ...
    function pImgSRC(num) {
      return ` 
       srcset="img/products/product__${num}--size1.webp 126w,
      img/products/product__${num}--size2.webp 174w,
      img/products/product__${num}--size3.webp 261w,
      img/products/product__${num}--size4.webp 348w"
      ...
      100vw"
       src="img/products/product__${num}--size1.webp" alt="" `;
    }
    function pName(num) {
      return `Produto #${num}`;
    }
